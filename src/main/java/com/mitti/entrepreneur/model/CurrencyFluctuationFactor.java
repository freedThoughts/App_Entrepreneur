...
public class CurrencyFluctuationFactor implements IMarketFactor {
    private final double weight;
    private int factorDegree;

    public CurrencyFluctuationFactor(double weight, int factorDegree) {
        this.weight = weight;
    ...
    public void printableFactorValue () {
        System.out.println("\n\t\t CURRENCY FLUCTUATION FACTOR : " + decimalFormat.format(factorValue()) + "  WEIGHT : " + weight);
    }
