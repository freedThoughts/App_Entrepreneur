...
public class CentralBankFactor implements IMarketFactor {
    private final double weight;
    private int factorDegree;

    public CentralBankFactor(double weight, int factorDegree) {
        this.weight = weight;
    ...
    public void printableFactorValue () {
        System.out.println("\n\t\t CENTRAL BANK INTEREST RATE FACTOR : " + decimalFormat.format(factorValue()) + "  WEIGHT : " + weight);
    }
